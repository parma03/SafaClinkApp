...
public class MainKonsumenActivity extends AppCompatActivity {
        ...
        AndroidNetworking.post(URL_UPDATE_PROFILE)
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonResponse.getString("code").equals("1")) {
                                ...
                                Toast.makeText(MainKonsumenActivity.this, "Profile berhasil diperbarui", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(MainKonsumenActivity.this, jsonResponse.getString("message"), Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(MainKonsumenActivity.this, "Error parsing response", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        hideLoading();
                        Toast.makeText(MainKonsumenActivity.this, "Terjadi kesalahan: " + anError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void initLoadingDialog() {
        loadingDialog = PopupDialog.getInstance(MainKonsumenActivity.this)
    ...
    private void performLogout() {
        ...
        Intent intent = new Intent(MainKonsumenActivity.this, MainActivity.class);

...
import com.example.safaclink.databinding.FragmentTabKonsumenBinding;
...
public class TabKonsumenFragment extends Fragment implements DialogAddUserActivity.OnUserAddedListener {
    private FragmentTabKonsumenBinding binding;
    private List<UserModel> userModelList;
    private UserAdapter userAdapter;
    private Dialog loadingDialog;
    private static final String URL_USER = ApiServer.site_url_admin + "getKonsumen.php";
    private static final String URL_SEARCH = ApiServer.site_url_admin + "searchKonsumen.php";
    private Context mContext;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentTabKonsumenBinding.inflate(inflater, container, false);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (response.getString("code").equalsIgnoreCase("1")) {
                                ...
                                userAdapter.setOnUserListChangedListener(() -> dataKonsumen());

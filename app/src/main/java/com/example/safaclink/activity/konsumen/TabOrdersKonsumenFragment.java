...
public class TabOrdersKonsumenFragment extends Fragment implements OrderKonsumenAdapter.OnPrintInvoiceListener {
    private FragmentTabOrdersKonsumenBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTabOrdersKonsumenBinding.inflate(inflater, container, false);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (response.getString("code").equalsIgnoreCase("1")) {
                                ...
                                orderKonsumenAdapter.setOnOrdersListChangedListener(() -> dataOrders());
                                orderKonsumenAdapter.setOnPrintInvoiceListener(TabOrdersKonsumenFragment.this);
